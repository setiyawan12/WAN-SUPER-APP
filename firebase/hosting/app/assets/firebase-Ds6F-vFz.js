 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LS(n){JA(xn),on(new kt("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return NS(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),et(Id,wd,n),et(Id,wd,"esm2017")}Pt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Pt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};LS();export{FS as A,ZS as B,US as C,HS as D,gi as E,xS as F,zt as G,CE as H,fE as I,fT as J,Wv as K,mo as L,p0 as M,_0 as N,ce as T,o0 as a,c0 as b,XS as c,e0 as d,zS as e,jS as f,KS as g,qS as h,$S as i,WS as j,BS as k,GS as l,s0 as m,r0 as n,l0 as o,f0 as p,n0 as q,u0 as r,h0 as s,d0 as t,a0 as u,m0 as v,i0 as w,Yy as x,QS as y,t0 as z};
