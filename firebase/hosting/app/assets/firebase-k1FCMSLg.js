 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LS(n){JA(xn),on(new kt("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return NS(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),et(Id,wd,n),et(Id,wd,"esm2017")}Pt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Pt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};LS();export{n0 as A,i0 as B,XS as C,US as D,gi as E,HS as F,zt as G,f0 as H,m0 as I,FS as J,ZS as K,d0 as L,l0 as M,u0 as N,ce as T,CE as a,fE as b,fT as c,Wv as d,QS as e,mo as f,xS as g,p0 as h,Yy as i,_0 as j,t0 as k,KS as l,qS as m,WS as n,zS as o,BS as p,GS as q,e0 as r,jS as s,s0 as t,$S as u,o0 as v,c0 as w,a0 as x,h0 as y,r0 as z};
